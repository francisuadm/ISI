...
get-remoteprogram -Property Publisher, InstallDate | Where-Object {$_.Publisher -match "Box*" -or
 $_.Publisher -like "CrowdStrike*" -or 
 $_.Publisher -like "Digital Guardian*" -or
 $_.Publisher -like "DisplayLink*" -or
 $_.Publisher -like "McAffee*" -or
 $_.ProgramName -match "Microsoft 365 Aps for enterprise - en-us" -or
 $_.Publisher -like "Palo Alto*" -or
 $_.ProgramName -like "*Password*" -or
 $_.Publisher -like "BeyondTrust*" -or
 $_.Publisher -like "Poly*" -or
 $_.Publisher -like "Zoom"} | Sort-Object -Property ProgramName > c:\IT_Folder\AppInstalled.txt

notepad.exe c:\IT_Folder\AppInstalled.txt
